...
public class ChenillardUDP3 {

    public static void main(String[] args) throws Exception {
        JFrame frame = new JFrame("Chenillard3");
        frame.setSize(300,300);
        frame.getContentPane().setBackground(Color.GREEN);
        frame.setVisible(true);
        Thread.sleep(1000); // Attendre une seconde

        int receivePort = 12347; // Port sur lequel ce programme reçoit
        int sendPort = 12348;    // Port sur lequel le programme suivant reçoit
